            ...
            <tr>
                ...
                <td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="780" align="center">
                        <tr bgcolor="#BCBCBC">
                            <td width="198"><img src="HTML/images/career.gif" width="198" height="29"></td>
                        ...
                        <tr valign="top">
                           ...
                           <td width="198" bgcolor="#FF3C40" background="HTML/images/fon_left.jpg" height="">
                            ...
                            <table width="270" height="380" border="1" bgcolor="#eaeaea" style="border-color: #D8B400">
                                <tr>
                                    <td height="36" colspan="3"><span class="style3">Current Openning </span></td>
                                </tr>
                                <tr>
                                    <td height="81" bordercolor="#000000"><h4>Job Title </h4></td>
                                    <td bordercolor="#000000"><h4>Experience</h4></td>
                                    <td bordercolor="#000000"><h4>Key Skills </h4></td>
                                </tr>
                                <tr>
                                    <td width="67" height="81" bordercolor="#000000"><p>Software Engineer </p></td>
                                    <td width="75" bordercolor="#000000"><p>Freshers</p></td>
                                    <td width="123" bordercolor="#000000"><p>Java/.Net/PHP</p></td>
                                </tr>
                                <tr>
                                    <td height="84" bordercolor="#000000"><p>Web Designer </p></td>
                                    <td bordercolor="#000000"><p>Freshers</p></td>
                                    <td bordercolor="#000000"><p>Html,Dhtml,Flash, CoralDraw</p>
                                    <p>PHotoShop</p></td>
                                </tr>
                                <tr>
                                    <td height="84" bordercolor="#000000"><p>Software Trainee </p></td>
                                    <td bordercolor="#000000"><p>Freshers</p></td>
                                    <td bordercolor="#000000"><p>Java/.Net/PHP</p></td>
                                </tr>
                            </table>
                            
                            <div style="font-size: 12px;">
                                <font color="orange"><b>  Submit Your Resume</b></font>
                            </div>  
                                ...
                                <table border="0">
                                    <form action="mail.jsp" method="post">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="file" name="f1" size="6">
                            ...
                            <p>mail your CV in Word Format</p>
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                            mail id:-&nbsp;&nbsp; <a href="mailto:career@itglobalsoftware.co.in"> career@itglobalsoftware.co.in</a>
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; <a href="mailto:hr@itglobalsoftware.co.in"> hr@itglobalsoftware.co.in</a>
                            <p align="justify" style="font-size: 12px;">&nbsp;</p></td>
