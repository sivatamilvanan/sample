                   ...
                   <%@include file="header.jsp"%>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="780" align="center">
                        <tr bgcolor="#BCBCBC">
                            ...
                            <td align="right" width="294"><img src="HTML/images/right01.gif" alt="" width="294" height="29" border="0"></td>
                        </tr>
                        <tr valign="top">
                            ...
                            <p align="justify" style="font-size: 12px;"><a href="index.jsp">Home</a></p>
                            <p align="justify" style="font-size: 12px;">Services</p>
                            <p align="justify" style="font-size: 12px;">Technology</p>
                            <p align="justify" style="font-size: 12px;"><a href="clients.jsp">Clients</a></p>
                            <p align="justify" style="font-size: 12px;"><a href="career.jsp">Career</a></p>
                            <p align="justify" style="font-size: 12px;"><a href="contact.jsp">Contact Us </a></p></td>
                            <td width="294" background="HTML/images/e03.gif">
                                <div align="center"><img src="HTML/images/right01.jpg" width="294" height="15" alt="" border="0"></div>
                                <table border="0" cellspacing="0" cellpadding="0" width="95%" background="" align="right">
                                    <tr>
                                        <td width="49%" align="left" valign="top">
                                            <a href=""></a><br>
                                            <a href=""></a><a href="product.jsp"><img src="HTML/images/bio.gif" alt="Biometric System" width="101" height="98" border="0"></a><br>
                                            <a href=""></a><br>
                                        </td>
                                        <td width="51%" align="left" valign="middle"><a href="product.jsp"><img src="HTML/images/hrms.gif" alt="HRMS" width="112" height="75" border="0"></a></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"><img src="HTML/images/e02.gif" width="271" height="12" alt="" border="0"></td>
                                    </tr>
                                    <tr>
                                        <td align="center" valign="top">
      
                                            <a href=""></a>  <a href="product.jsp"><img src="HTML/images/erp12.gif" alt="ERP" width="130" height="99" border="0"></a><br>
                                            <a href=""></a><br>
                                        </td>
                                        <td align="center" valign="top"><a href="product.jsp"><img src="HTML/images/credit.gif" alt="E-COMMERCE" width="125" height="100" border="0"></a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
