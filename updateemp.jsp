            ...
            <td>
                ...
                <tr valign="top">
                    ...
                    <td width="582" height="300">
                        ...
                        <table border=0 bgcolor="#CCCCCC" width="400" height="100" class="form-field" align=center>  
                            <form action="updateempall.jsp" method="post">
                                <div><tr><td align="center"> <Select name="users" >
                ...
                Connection con=DriverManager.getConnection("jdbc:mysql:///itglobal", "java","java");
                                        ...
                                        while(rs.next()) {
                                            ...
                                            String value=rs.getString(13);
                                            //out.println(value);
                                            // session.setAttribute("emp_email1",value);
                                %>
                             ...
                             <TABLE>
                                <TR>
                                    <TD><FORM ACTION="admindetail.jsp" method="get" >
