...
<html>
    ...
    <body  leftmargin=0 topmargin=0 marginheight="0" marginwidth="0" bgcolor="#ffffff" onload="photoGallery()">
        <map name="map01">
            <area href="" alt="" coords="44, 14, 96, 31" shape="rect">
            <area href="" alt="" coords="100, 14, 166, 31" shape="rect">
        </map>
                ...
                <td>
                   ...
                   <table border="0" cellspacing="0" cellpadding="0" width="780" align="center">
                        ...
                        <tr valign="top">
                            ...
                            <td width="288">
                            <p>We used Sun Microsystems 
                            technologies:- 
                            <ul>
                                <li><font face="Palatino Linotype">&nbsp; Jdk1.5/jdk1.6</font></li>
                                <li><font face="Palatino Linotype">&nbsp; J2ee1.4</font></li>
                                <li><font face="Palatino Linotype">&nbsp; 
                                Servlet,Jsp,Ejb,RMI,JMS</font></li>
                            </ul>
                            <p>&nbsp;&nbsp;&nbsp;&nbsp; 
                            Frameworks:-
                            <ul>
                                <li><font face="Palatino Linotype">&nbsp; Struts</font></li>
                                <li><font face="Palatino Linotype">&nbsp; Spring</font></li>
                                <li><font face="Palatino Linotype">&nbsp; Hibernate</font></li>
                                <li><font face="Palatino Linotype">&nbsp; JSF</font></li>
                            </ul>
                            <p><font face="Palatino Linotype">&nbsp; Development IDE:-</font>
                            <ul>
                                <li><font face="Palatino Linotype">&nbsp;MyEclipse</font></li>
                                <li><font face="Palatino Linotype">&nbsp;NetBean</font></li>
                            </ul>
                            <p></p>
                             <p>
                            <img src="HTML/images/fig10.gif" width="300" height="300" alt="" border="0">
                            </p>
