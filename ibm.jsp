                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="780" align="center">
                        ...
                        <tr valign="top">
                           ...
                           <td width="198" bgcolor="#FF3C40" background="HTML/images/fon_left.jpg" height="">
                            ...
                            <P class=style9 align=justify>IT Global Software is now using IBM AS/400 middleware 
                            technology</P>
                            <P class=style9 align=justify>AS/400 Technology</P>
                            <ul>
                                <li>
                                    <P class=style9 align=justify>OS/400</P>
                                </li>
                                <li>
                                    <P class=style9 align=justify> CL/400,RPG/400,RPGIV,COBOL,Java</P>
                                </li>
                                <li>
                                    <P class=style9 align=justify>ILECL, ILERPG</P>
                                </li>
                                <li>
                                    <P class=style9 align=justify>SYNON</P>
                                </li>
                            </ul>
                            <p align="justify" style="font-size: 12px;">&nbsp;</p>
                            
                            <p>
                            <img src="HTML/images/ibm_solution.png" alt="" width="300" height="300" border="0">
                            </p>
