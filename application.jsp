            ...
            <tr>
                ...
                <td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="780" align="center">
                        <tr bgcolor="#BCBCBC">
                            <td width="198"><img src="HTML/images/application.gif" width="198" height="29"></td>
                        ...
                        <tr valign="top">
                          ...
                          <td width="198" bgcolor="#FF3C40" background="HTML/images/fon_left.jpg" height="">
                            ...
                            <td align="left" width="570" bgcolor="#eaeaea">
                                ...
                                <p align="justify">
                                    We analyze a project and define its goals, and plan a detail roadmap to achieve those goals. By following a rigorous and proven methodology of defining, designing and developing software projects, we turn project concepts into reality. With Icreon as your software Outsourcing Partner, you can reap benefits of Offshore IT Outsourcing & “best-in-class" offshore application and software outsourcing services in India
                                </p>
                                <p align="justify">
                                    We work with latest technologies and architecture and in various industries. Like: 
                                </p>
                                <p align="left">
                                    <ul>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">Windows DNA / .Net development </li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">Win32 API (incl. shell API, interprocess comm) </li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">COM/DCOM, ActiveX, OLE </li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">MTS</li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">MSMQ </li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">ODBC, DAO, OLE DB </li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">J2SE (JDK 1.2) </li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">J2EE EJB (Enterprise Java Beans)    </li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">Oracle Application Development</li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">MAPI, TAPI, SAPI  </li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">TCP/IP, sockets  </li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">Unix API (incl Sockets and stream API) </li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000"> PHP Development </li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">SugarCRM Development</li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">Asp development </li>
                                        <li style="list-style-type: square;font-size:12px;color:F88C32;"><font color="#000000">Net 2.0 Development </li>
                                    </ul>
                                </p>
