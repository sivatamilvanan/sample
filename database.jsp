                        ...
                        <tr bgcolor="#BCBCBC">
                         ...
                         <tr valign="top">
                            ...
                            <td align="left" width="570" bgcolor="#eaeaea">
                               ...
                               <p align="justify" style="font-size: 12px;"><font color="#AD8C37">We are using best database form the market.</font>
                                <ul>
                                    ...
                                    <li>Microsoft SQL Server 7</li>
                                </ul>
                                
                               <p>
                               <img src="HTML/images/database-image.jpg" alt="" width="330" height="300" border="0">
                               </p>
