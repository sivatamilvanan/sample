            ...
            <tr>
                ...
                <td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="780" align="center">
                        <tr bgcolor="#BCBCBC">
                            <td width="198"><img src="HTML/images/erp.gif" width="198" height="29"></td>
                       ...
                       <tr valign="top">
                         <td width="198" bgcolor="#FF3C40" background="HTML/images/fon_left.jpg" height="">
                            ...
                            <td width="432">
                            <p>
                          <font color="F28A35">  ERP India (Enterprise Wide Solutions) </font>
                            </p>
                            
                            
                               <p align="justify" style="font-size: 12px;">Enterprise solutions provide a centralized framework for all data and processes of an organization. It integrates all aspects of a business from planning to inventory control, manufacturing, sales, marketing, finance, customer service and human resources. </P>
                               <p align="justify" style="font-size: 12px;">
                               A significant part of our services portfolio is our customized ERP solutions. At Icreon, we provide cost effective enterprise solutions that are developed and customized keeping in mind the individual requirements of clients and their areas of operation. Our process experts will evaluate every detail and thoroughly assess each option that they draw for your organization.
                               </p>
                                <p>
                               <font color="F28A35"> Itglobalsoftware offers the following ERP solutions to organizations across domains:</font>
                                </p>
                                
                                <p>
                             <img src="HTML/images/erp_1_big.gif" width="350" height="450"/>
                             </p>
